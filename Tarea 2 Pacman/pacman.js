...
function main() 
{
    ...
    mat4.translate(modelViewMatrix, modelViewMatrix, [-1.3, 0.8, -3.333]);
    ...
    //Draw a rombo
    mat4.identity(modelViewMatrix);
    mat4.translate(modelViewMatrix, modelViewMatrix, [-1.2, -1.2, -3.33333]);
    bindShaderAttributes(gl, shaderProgram);
...
function createPacman(gl)
{
    ...
    for (let i = 0; i <= 140; i++) {
        points.push((r * Math.cos(i * 2 * Math.PI / 180 + mouth)))
        points.push((r * Math.sin(i * 2 * Math.PI / 180 + mouth)))
    }
